            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="#" onclick="event.preventDefault(); document.getElementById('form-logout').submit()"
                            >Çıkış</a></li>
                        <form id="form-logout" method="post" action="{{route('kullanici.oturumukapat')}}" style="display: none;">
                            {{csrf_field()}}
                        </form>
                    </ul>
                </li>
