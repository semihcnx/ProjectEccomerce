...
{{csrf_field()}}
                            ...
                            <div class="form-group">
                                <label for="password-tekrari" class="col-md-4 control-label">Şifre (Tekrar)</label>
                                <div class="col-md-6">
                                    <input id="password-tekrari" type="password" class="form-control" name="password_confirmation" required>
                                </div>
                            </div>
