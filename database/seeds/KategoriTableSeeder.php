...
class KategoriTableSeeder extends Seeder
{
    ...
    public function run()
    {
       // DB::table('kategori')->truncate();
        ...
        DB:: table('kategori')->insert(['kategori_adi'=>'Tv ve Ses Sistemleri','slug'=>'tv-ses-sistemeleri','ust_id'=>$id]);
       ...
       $id= DB::table('kategori')->insertGetId(['kategori_adi'=>'Kitap','slug'=>'kitap']);
        ...
        DB:: table('kategori')->insert(['kategori_adi'=>'Polisiye','slug'=>'polisiye','ust_id'=>$id]);
        ...
        DB::table('kategori')->insert(['kategori_adi'=>'Giyim ve Moda','slug'=>'giyim-noda']);
